...
//
// This file defines shared types, error codes, and helpers used by both client
// and server implementations of the sharded key/value store.
...
type PutArgs struct {
	...
	Seq    int64   // Monotonic client sequence for at-most-once semantics
